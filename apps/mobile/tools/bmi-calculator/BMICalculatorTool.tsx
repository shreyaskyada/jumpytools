  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: cardBg, borderRadius: 16, borderWidth: 1, borderColor: cardBorder, padding: 20, alignItems: 'center' }}>
        <Activity size={48} color="#f59e0b" style={{ marginBottom: 12 }} />
        ...
        <Text style={{ fontSize: 13, color: textMuted, textAlign: 'center', lineHeight: 18 }}>
          Please use the desktop/web version to toggle metric/imperial units, slide through standard World Health Organization (WHO) index groups, and view target weight thresholds.
        </Text>
      </View>
    </ScrollView>
  );
