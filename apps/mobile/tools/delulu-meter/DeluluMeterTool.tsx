  ...
  return (
    ...
    >
      <View style={{ marginBottom: 24 }}>
        <View style={{ alignSelf: 'flex-start', backgroundColor: isDark ? 'rgba(168,85,247,0.15)' : 'rgba(168,85,247,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, marginBottom: 10 }}>
          <Text style={{ fontSize: 10, fontWeight: '700', letterSpacing: 1.2, textTransform: 'uppercase', color: '#a855f7' }}>
            Fun & Games
          </Text>
        </View>
        ...
        <Text style={{ fontSize: 14, color: textMuted, marginTop: 4, lineHeight: 20 }}>
          Measure your delusion level instantly and get a detailed reality breakdown.
        </Text>
      </View>

      <View style={{ backgroundColor: cardBg, borderRadius: 16, borderWidth: 1, borderColor: cardBorder, padding: 20, alignItems: 'center' }}>
        <Gauge size={48} color="#a855f7" style={{ marginBottom: 12 }} />
        ...
        <Text style={{ fontSize: 13, color: textMuted, textAlign: 'center', lineHeight: 18 }}>
          Please use the desktop/web version to input your personal scenarios, configure custom delusion multipliers, and view your diagnostic radar metrics and roasts.
        </Text>
      </View>
    </ScrollView>
  );
